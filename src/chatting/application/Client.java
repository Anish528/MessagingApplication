	...
	Client(){
		...
		p1.add(l1);
            ...
            public void mouseClicked(MouseEvent ae){
                ...
                ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/logo.png"));
		...
		setLayout(null);
                ...
                a1.setFont (new Font("SAN_SHERIF",Font.PLAIN, 16));
               ...
               t1.setFont (new Font("SAN_SHERIF",Font.PLAIN, 16));
               add (t1);
               ...
               b1 = new JButton("Send");
                ...
                b1.setFont (new Font("SAN_SHERIF",Font.PLAIN, 16));
